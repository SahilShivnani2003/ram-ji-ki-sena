...
export const CustomDrawerContent: React.FC<customDrawerProps> = props => {
    const insets = useSafeAreaInsets();
    const { t } = useI18n();
    const { state, navigation, drawerItems } = props;

    const handleItemPress = (routeName: string) => {
        navigation.navigate(routeName);
    };

    // App is already wrapped in SafeAreaView, so avoid double top inset in drawer header
    const headerTopPadding = Spacing.sm;
        ...
        <View style={styles.container}>
            ...
            <View style={[styles.header, { paddingTop: headerTopPadding }]}>
                <View style={styles.logoContainer}>
                    ...
                    <Text style={styles.appTitle}>Ram Ji Ki Sena</Text>
                </View>
